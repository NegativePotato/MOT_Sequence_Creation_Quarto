...
compute_target_density_wrapper <- function(data, target_sets, start_frame, end_frame) {
  ...
  # Export everything the workers need to run compute_target_density()
  clusterExport(cl, varlist = c("compute_target_density", "data", "start_frame", "end_frame"),
                envir = environment())
  clusterEvalQ(cl, library(dplyr))
  
  target_density_per_frame.list <- parLapply(cl, target_sets, function(target_set) {
